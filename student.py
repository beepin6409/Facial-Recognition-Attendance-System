...
class Student:
    def __init__(self, root):
        ...
        img=img.resize((490,200),Image.ANTIALIAS)  # ANTIALIAS converts high level image into low levels
        ...
        img1=img1.resize((490,200),Image.ANTIALIAS)  # ANTIALIAS converts high level image into low levels
        ...
        img2=img2.resize((500,200),Image.ANTIALIAS)  # ANTIALIAS converts high level image into low levels
            ...
            try:
                ...
                while True:
                    ...
                    if cropped_face is not None:
                        ...
                        cv2.putText(face,str(img_id),(50,50),cv2.FONT_HERSHEY_COMPLEX,2,(0,255,100),2)
